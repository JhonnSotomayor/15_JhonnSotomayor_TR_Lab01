...
--Creamos las relacion entre la tabla Participante y registro
ALTER TABLE REGISTRO ADD CONSTRAINT PARTICIPANTE_REGISTRO
	FOREIGN KEY (IDPAR)
	REFERENCES PARTICIPANTE(IDPAR)
GO

--Creamos las relacion entre la tabla RegistroDetalle y registro
...
--Creamos las relacion entre la tabla RegistroDetalle y conferencia
...
--Creamos las relacion entre la tabla Conferencia y ponente
